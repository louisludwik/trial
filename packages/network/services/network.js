          ...
          */
            ...
            */
            ...
            /*
             ...
             "profile_image":"https://s3-eu-west-1.amazonaws.com/gpimg/45661eff6323f17ee42d90fe2fa0ad8dcf29d28a67619f8a95babf4ace48ff96.jpg"}}
             */
            updateNetwork: function(networkId, params, success, error) {
                dataService.put('/networks/' + networkId, params, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
            ...
            */
            ...
            searchNetwork: function(name,params, success, error) {
                dataService.get('/search/groups/'+name, params, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
            ...
            /*
             ...
             Example response: (HTTP 200)
             [{"id":9, "name":"Steph", "profile_image":"https://gleepost.com/uploads/35da2ca95be101a655961e37cc875b7b.png"},
             {"id":23, "name":"Steve", "profile_image":"https://gleepost.com/uploads/35da2ca95be101a655961e37cc875b7b.png"}]
             */
            searchForUser: function(name, success, error) {
                dataService.get('/search/users/'+name,{}, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
            ...
            makeAdminInNetwork: function(networkId,params, success, error) {
                dataService.post('/networks/' + networkId + '/admins',params, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
            },
            removeAdminInNetwork: function(networkId,userID, success, error) {
                dataService.delete('/networks/' + networkId + '/admins/'+userID,{}, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
            },
            getAllAdminsInNetwork:function(networkId,success,error){
                dataService.get('/networks/' + networkId + '/admins',{}, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
