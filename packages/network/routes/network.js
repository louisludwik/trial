...
angular.module('gleepostweb.network').config(['$stateProvider',
    function($stateProvider) {
        ...
        $stateProvider
            .state('networks', {
                url: '/networks',
                templateUrl: 'packages/network/views/networks.html',
                resolve:{
            ...
            .state('networks.mine', {
                url: '/mine',
                templateUrl: 'packages/network/views/mynetworks.html',
                resolve:{
                    loggedin:checkLoggedOut
                }
            })
            .state('networks.search', {
                url: '/searched',
                templateUrl: 'packages/network/views/searchednetworks.html',
                resolve:{
                    loggedin:checkLoggedOut
                }
            })
            ...
            .state('network.settings', {
                url: '/settings',
                templateUrl: 'packages/network/views/settings.html',
                resolve:{
                    loggedin:checkLoggedOut
                }
            })
