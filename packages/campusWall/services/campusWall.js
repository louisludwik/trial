        ...
        return {
            ...
            */
            ...
            /*
                ...
                {"id":3}
            */
            addPost: function(params, success, error) {
            ...
            */
            getEventPosts: function(params, success, error) {
                dataService.get('/live', params, true, true)
                    .success(function(response) {
                        success(response);
                        return response;
                    }).error(error);
            ...
            */
            ...
            uploadFile:function(file,params,success,error){
                
                dataService.postFile('/upload',file,params,true,true)
                    .success(function(response){
